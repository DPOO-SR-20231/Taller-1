...
public class ConsolaOlimpicos
{
		...
		while (continuar)
		{
			try
			{
				...
				if (opcion_seleccionada == 1)
					...
					ejecutarAtletasPorNombreySuPais();
	...
	private void ejecutarAtletasPorNombreySuPais()
	{
		System.out.println("\n" + "Busque el país de un atleta" + "\n");

		String atleta = input("Por favor ingrese el nombre de un atleta");
		Pais pais = calculadora.buscarAtletayDarPais(atleta);
		String paiss = pais.darNombre();
		...
		{
			System.out.println("El pais de " + atleta + " es " + paiss);
		}
	}
